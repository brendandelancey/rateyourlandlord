...
const actions = {
    ...
    async register({
        ...
        try {
            ...
            var res = await axios.post('http://rateyourstudenthouse.com/api/users/register', userData);
    ...
    async getProfile({
        ...
        var res = await axios.get('http://rateyourstudenthouse.com/api/users/profile')
