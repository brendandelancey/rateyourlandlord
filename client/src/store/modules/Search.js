...
const mutations = {
  setAddressSearchResults: (state, queryAddress) =>
    (state.queryResults = queryAddress),
  setLandlordSearchResults: (state, queryLandlords) =>
    (state.queryResults = queryLandlords),
};
